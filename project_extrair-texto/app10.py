...
def cortar_retangulo():
    ...
    # Codificar a imagem cortada em base64
    retval, buffer = cv2.imencode('.jpg', retangulo_cortado)
    retangulo_cortado_base64 = base64.b64encode(buffer).decode('utf-8')
    
    return jsonify({'retangulo_cortado_base64': retangulo_cortado_base64})
